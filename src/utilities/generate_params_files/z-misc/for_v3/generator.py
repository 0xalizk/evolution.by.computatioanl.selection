...
command_prefix ="python /home/mosha/EvoByCompSel/parallel/Release-03/src/simulation/resilience/v3mpi/launchers/launcher_v3.py "
appendex = "\n# comments: \
...
for f in edge_files:
    ...
    for c in configs:
        out_file = '_'.join((host, c[11],c[0], c[8].split('/')[-1].split('.')[0], c[2], c[6], c[1]))+'.params'
