...
for data_file in  BY_GENE_datafiles:
    ...
    labels              = ['ZeroOne', 'OneTwo', 'TwoThree', 'ThreeFour', 'FourFive', 'AboveFive']
    #print ("duplicates: "+ str(len( df.duplicated (subset=['p','t', 'Gene']))))
    #df= df.drop_duplicates (subset=['p','t', 'Gene'])
    ...
    for measure in plots.keys():
        ...
        for deg_range in bins:
            ...
            legend_colors.append(plt.Rectangle ((0,0),1,1,fc=colors[plots[measure]['color']][i]))
            legend_labels.append(current_range)
            
            i+=1
                
        legend_colors.reverse()
        legend_labels.reverse()
        ax.legend(legend_colors,legend_labels,frameon=False)
